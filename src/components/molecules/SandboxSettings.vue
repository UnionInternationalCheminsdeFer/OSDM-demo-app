    ...
    >
      <div class="text-osdm-text flex flex-col w-screen md:w-auto pr-8">
        ...
        <p class="text-sm md:text-base mb-5 font-normal">
          ...
          You can find documentation about the authentication
          <a
            class="text-osdm-bg-primary"
            href="https://osdm.io/spec/authentication/#jwts"
            target="_blank"
            >here</a
        ...
        <form class="flex flex-col gap-4 items-center">
          ...
          <sbb-form-field error-space="none" size="m" class="md:w-96">
            ...
            <input
              placeholder="https://osdm-5.platform.bileto.zone/api/"
              name="message"
              v-model="authURL"
            />
          </sbb-form-field>
